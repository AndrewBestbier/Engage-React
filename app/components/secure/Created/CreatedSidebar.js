...
var CreatedSidebar = React.createClass({
    ...
    return (
      <div id="sidebar-wrapper">
          <ul className="sidebar-nav">
              <li>
                <Link to="createdquestions" params={{roomid: this.state.roomid}}> 
              ...
              <li>
                  <Link to="createdpolls" params={{roomid: this.state.roomid}}> 
              ...
              <li>
                  <Link to="createdsettings" params={{roomid: this.state.roomid}}> 
